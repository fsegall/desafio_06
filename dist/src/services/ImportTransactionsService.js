...
var ImportTransactionsService = /** @class */ (function () {
    ...
    ImportTransactionsService.prototype.execute = function (filePath) {
        return __awaiter(this, void 0, void 0, function () {
            var transactionsRepository, categoriesRepository, contactsReadStream, parsers, parseCSV, transactions, categories, existentCategories, existentCategoriesTitle, addCategoryTitles, newCategories, finalCategories, createdTransactions;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, existentCategories.map(function (category) { return category.title; })];
                    case 3:
                        existentCategoriesTitle = _a.sent();
                        addCategoryTitles = categories.filter(function (category) { return !existentCategoriesTitle.includes(category); })
